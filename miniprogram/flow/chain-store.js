...
function createChainStore(api, { memoryLimit = 8, byteLimit = 3 * 1024 * 1024 } = {}) {
  ...
  return { get, put, path, saveWindow, previousWindow, stats: () => ({ memory: memory.size, saved: Object.keys(index).length }) };
}
