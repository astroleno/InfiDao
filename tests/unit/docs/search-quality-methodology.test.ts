...
describe("search quality methodology", () => {
  it("records immutable artifact identities and independent holdout rules", () => {
    ...
    expect(methodology).toContain("609a792179b7118c7c111744b9bc6a1702092326");
    ...
    expect(methodology).toContain("--fixture-commit <exact fixture commit SHA supplied by the independent reviewer>");
